...
Pod::Spec.new do |s|
  s.name             = 'NaruiMapKit'
  s.version          = '0.1.0'
  s.summary          = 'A short description of NaruiMapKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/서창열/NaruiMapKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '서창열' => 'kongbaguni@gmail.com' }
  s.source           = { :git => 'https://github.com/서창열/NaruiMapKit.git', :tag => s.version.to_s }
